...
from espm.utils import symbol_to_number_dict, symbol_to_number_list
...
class EDXS(PhysicalModel):
        ...
        # model based on elements_list
            ...
            if self.bkgd_in_G:
                ...
                if np.max(brstlg_spectrum) > 0.0:
                    ...
                    print(
                        "Bremsstrahlung parameters were not provided, bkgd not added in G"
                    )
                    self.bkgd_in_G = False
    ...
    def generate_phases(self, phases_parameters):
        ...
        self.phases = []
        unique_elts = dict(
            elts_dict_from_dict_list([x["elements_dict"] for x in phases_parameters])
        )
    ...
    def generate_spectrum(
        self, b0=0, b1=0, scale=1.0, abs_elts_dict={}, *, elements_dict={}
    ):
        r"""
    ...
    @symbol_to_number_dict
    def bremsstrahlung_only_tools(
        self, *, mass_thickness=1.0, ranges=None, elements_dict={}
    ):
