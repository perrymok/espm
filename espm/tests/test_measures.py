...
def test_find_min_angle():
    ...
    true_res_u = (
        [41.100923139683005, 41.29114572254828, 44.37587131209638, 38.446115521694054],
        (1, 2, 3, 0),
    )
    ...
    true_res_g = (
        [38.446115521694054, 38.95264025554747, 41.22519848513551, 38.446748219852694],
        [3, 3, 0, 3],
    )
