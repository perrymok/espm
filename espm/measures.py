...
def find_min_config(true_maps, true_spectra, algo_maps, algo_spectra, angles=True):
    ...
    min_angle_config = find_min_angle(
        true_spectra, algo_spectra, get_ind=True, unique=True
    )[1]
    warning = False
    ...
    if angles:
        ...
        corresponding_angles = ordered_angles(
            true_spectra, algo_spectra, min_MSE_config
        )
